...
export class Map extends Component {
    ...
    componentDidMount() {
        ...
        script.src = "https://maps.googleapis.com/maps/api/js?sensor=false&key=AIzaSyDx7uNRz2GYWKLlAlfT6wugFOSBXQ7EZaQ&callback=googleMapsCallback&language=hr&region=BA";
        script.async = true;
        script.defer = true;
